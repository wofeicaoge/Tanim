...
from tanim.core.container.container import Container
from tanim.core.mobject.mobject import Mobject
from tanim.core.scene.scene_file_writer import SceneFileWriter

from tanim.extention.animation.creation import Write
from tanim.extention.mobject.svg.tex_mobject import TextMobject
from tanim.extention.animation.transform import MoveToTarget, ApplyMethod
...
class Scene(Container):
    ...
    def __init__(self, **kwargs):
        ...
        if not self.file_writer.livestreaming:
