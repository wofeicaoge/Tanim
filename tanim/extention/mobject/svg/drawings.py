...
from tanim.core.animation.rotation import Rotating
...
from tanim.extention.mobject.three_dimensions import Cube
from tanim.extention.mobject.geometry import Circle, AnnularSector, Arc, Line, Polygon, Rectangle, Square, DashedLine
...
class ThoughtBubble(Bubble):
    ...
    def make_green_screen(self):
        self.submobjects[-1].set_fill(Color('GREEN_SCREEN'), opacity=1)
        return self
...
class PlayingCard(VGroup):
    ...
    def generate_points(self):
        ...
        if self.turned_over:
            self.set_fill(Color('GREY'))
            self.set_stroke(Color('GREY'))
